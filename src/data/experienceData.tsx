...
export const experiences: Experience[] = [
  {
    ...
    bullets: [
      "Built AI-powered painting quote flow; cut lead response time from ~24h to <5m.",
      "Shipped before/after gallery and image upload; +38% conversion from visitors to leads.",
      "Implemented price estimator & CRM export; reduced manual quoting by 60%.",
    ],
    gallery: [
